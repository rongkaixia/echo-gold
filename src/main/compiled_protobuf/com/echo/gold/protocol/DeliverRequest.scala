...
@SerialVersionUID(0L)
final case class DeliverRequest(
    orderId: String = ""
    ...
    def mergeFrom(__input: com.google.protobuf.CodedInputStream): com.echo.gold.protocol.DeliverRequest = {
      ...
      com.echo.gold.protocol.DeliverRequest(
          orderId = __orderId
      )
    }
    def withOrderId(__v: String): DeliverRequest = copy(orderId = __v)
    ...
    def companion = com.echo.gold.protocol.DeliverRequest
}
...
object DeliverRequest extends com.trueaccord.scalapb.GeneratedMessageCompanion[DeliverRequest] {
  ...
  def fromFieldsMap(__fieldsMap: Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.gold.protocol.DeliverRequest = {
  ...
  def descriptor: com.google.protobuf.Descriptors.Descriptor = ProtocolProto.descriptor.getMessageTypes.get(4)
  def messageCompanionForField(__field: com.google.protobuf.Descriptors.FieldDescriptor): com.trueaccord.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__field)
  def enumCompanionForField(__field: com.google.protobuf.Descriptors.FieldDescriptor): com.trueaccord.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__field)
  lazy val defaultInstance = com.echo.gold.protocol.DeliverRequest(
  )
