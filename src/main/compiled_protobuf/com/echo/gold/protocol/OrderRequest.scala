...
final case class OrderRequest(
    ...
    def mergeFrom(__input: com.google.protobuf.CodedInputStream): com.echo.gold.protocol.OrderRequest = {
      ...
      com.echo.gold.protocol.OrderRequest(
          userId = __userId,
          title = __title,
    ...
    def withPayMethod(__v: com.echo.gold.protocol.PayMethod): OrderRequest = copy(payMethod = __v)
    def withDeliverMethod(__v: com.echo.gold.protocol.DeliverMethod): OrderRequest = copy(deliverMethod = __v)
    ...
    def companion = com.echo.gold.protocol.OrderRequest
}
...
object OrderRequest extends com.trueaccord.scalapb.GeneratedMessageCompanion[OrderRequest] {
  ...
  def fromFieldsMap(__fieldsMap: Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.gold.protocol.OrderRequest = {
  ...
  def descriptor: com.google.protobuf.Descriptors.Descriptor = ProtocolProto.descriptor.getMessageTypes.get(0)
  ...
  lazy val defaultInstance = com.echo.gold.protocol.OrderRequest(
  )
